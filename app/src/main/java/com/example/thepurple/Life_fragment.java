...
public class Life_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState){
        View view = inflater.inflate(R.layout.life_frag,container,false);
        //实现瀑布布局，初始时在首页
        RecyclerView recyclerview = (RecyclerView) view.findViewById(R.id.life_recycler_view);
        StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(3,
                StaggeredGridLayoutManager.VERTICAL);
        recyclerview.setLayoutManager(layoutManager);
        Ground_Adapter adapter = new Ground_Adapter(getlifeMesgList());
    ...
    private List<AccountMesg> getlifeMesgList(){
        ...
        Collections.reverse(lifeMesgList);//倒序
        return lifeMesgList;
    }
}
